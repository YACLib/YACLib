...
[[nodiscard]] Contract<V, T> MakeContract() {
  auto core = MakeUnique<detail::UniqueCore<V, T>>();
  Future<V, T> future{detail::UniqueCorePtr<V, T>{NoRefTag{}, core.Get()}};
  Promise<V, T> promise{detail::UniqueCorePtr<V, T>{NoRefTag{}, core.Release()}};
...
[[nodiscard]] ContractOn<V, T> MakeContractOn(IExecutor& e) {
  ...
  FutureOn<V, T> future{detail::UniqueCorePtr<V, T>{NoRefTag{}, core.Get()}};
  Promise<V, T> promise{detail::UniqueCorePtr<V, T>{NoRefTag{}, core.Release()}};
  return {std::move(future), std::move(promise)};
}
